...
if __name__ == "__main__":
    ...
    CONFIG = ReleaseConfig(
        version="patch",
        notes=(
            "🔊 게임 곳곳에 아기자기한 효과음이 생겼어요 — 심기·수확·잡초·구매·강화·도감·채팅 알림까지! 설정에서 끄고 켤 수 있어요. "
            "💬 채팅을 연달아 보내도 씹히지 않고 순서대로 전송되고, 채팅창은 마우스가 살짝 벗어나도 바로 닫히지 않아요. "
            "⚡ 서리 중 상대 커서가 훨씬 부드럽게 움직이고, 접속이 끊긴 친구가 온라인처럼 보이던 문제도 고쳤어요."
        ),
