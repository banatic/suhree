...
if __name__ == "__main__":
    ...
    CONFIG = ReleaseConfig(
        version="0.3.4",  # 명시 버전 — package.json/Cargo.toml/tauri.conf.json 0.3.4으로 일괄 변경
        notes=(
            "🙈 밭 접기 — 밭 가운데 작은 갈색 바를 누르면 밭을 접어 뒤 화면(작업 표시줄 등)을 클릭할 수 있어요. 다시 누르면 펴지고, 서리 중엔 자동으로 펴져요.\n"
            "🌿 잡초 스킨 8종 — 꾸미기에서 친구 밭에 심을 잡초를 골라요! 팻말·강아지풀·민들레꽃·깃발·똥·독버섯·네잎클로버·무지개똥.\n"
            "🏷️ 잡초에 심은 사람 닉네임이 도장처럼 남아요 — 여러 명이 같이 털 때도 실시간으로 보여요."
        ),
