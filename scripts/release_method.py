...
if __name__ == "__main__":
    ...
    CONFIG = ReleaseConfig(
        version="patch",
        notes=(
            "✨ 스페셜 작물 라인 추가! 도감을 완성하면 은은하게 빛나는 엔드게임 전용 작물이 열려요. "
            "별무를 시작으로 수확을 거듭하면 수정밀·불꽃호박·오로라무·태양과가 차례차례 해금되는 장기 도전 과제예요. "
            "내 밭은 물론 친구 밭 미리보기에서도 반짝반짝 빛나니, 진짜 농사 고수라는 걸 뽐내 보세요!"
        ),
